...
Light.prototype.setMode = function (mode) {
    ...
    utils.sendUDPWrite(this, 0x03, 0x01, [mode], false);
};
...
Light.prototype.setBrightness = function (brightness) {
    ...
    utils.sendUDPWrite(this, 0x03, 0x02, [brightness], false);
};
 ...
 */
Light.prototype.setAmbientModeType = function (ambientModeType) {
    ...
    utils.sendUDPWrite(this, 0x03, 0x08, [ambientModeType], false);
};
 ...
 */
Light.prototype.setAmbientColor = function (ambientColor) {
    ...
    utils.sendUDPWrite(this, 0x03, 0x05, [ambientColor], false);
};
...
Light.prototype.setAmbientShow = function (ambientShow) {
    ...
    utils.sendUDPWrite(this, 0x03, 0x0D, [ambientShow], false);
};
...
Light.prototype.setHdmiInput = function (hdmiInput) {
    ...
    utils.sendUDPWrite(this, 0x03, 0x20, [hdmiInput], false);
};
